...
-   [BOJ 15719](../master/python/BOJ_15719.py)
    ...
    read()를 참고하며 본 방법인데 중복된 문자는 1개, 1 ~ n-1까지의 수로 이루어진 수열이라는 특징을 이용해 **1 ~ n-1의 총 합(n\*(n-1)//2)에서 수열에 존재하는 모든 수를 뺀 값에 -를 붙이면**+ 정답이 나오게 된다.. 역시 배울 게 남아도 너무 많이 남았다고 생각한다.
...
-   [BOJ 1916](../master/python/BOJ_1916.py)
    ...
    재채점 결과 메모리초과가 되어 동일한 방법으로 문법만 편해진 방법으로 작성하여 풀었더니 CA 결과를 다시 받았다. 4달전에 비해서 많이 성장했다고 느꼈다.
...
-   [프로그래머스 다리를지나는트럭](../master/python/프로그래머스_다리를지나는트럭.py)
...
-   [프로그래머스 전화번호목록](../master/python/프로그래머스_전화번호목록.py)
...
-   [BOJ 3055](../master/python/BOJ_3055.py)
...
-   [프로그래머스 N으로표현](../master/python/프로그래머스_N으로표현.py)
...
-   [프로그래머스 정수삼각형](../master/python/프로그래머스_정수삼각형.py)
...
-   [BOJ 1946](../master/python/BOJ_1946.py)
...
-   [BOJ 2252](../master/python/BOJ_2252.py)
...
-   [BOJ 17845](../master/python/BOJ_17845.py)
...
-   [BOJ 1766](../master/python/BOJ_1766.py)
...
-   [프로그래머스 단어변환](../master/python/프로그래머스_단어변환.py)
...
-   [BOJ 1516](../master/python/BOJ_1516.py)
...
-   [BOJ 2565](../master/python/BOJ_2565.py)
...
-   [프로그래머스 여행경로](../master/python/프로그래머스_여행경로.py)
...
-   [프로그래머스 위장](../master/python/프로그래머스_위장.py)
...
-   [프로그래머스 소수찾기](../master/python/프로그래머스_소수찾기.py)
...
-   [프로그래머스 조이스틱](../master/python/프로그래머스_조이스틱.py)
...
-   [BOJ 20040](../master/python/BOJ_20040.py)
...
-   [BOJ 13308](../master/python/BOJ_13308.py)
...
-   [BOJ 1300](../master/python/BOJ_1300.py)
...
-   [프로그래머스 등굣길](../master/python/프로그래머스_등굣길.py)
...
-   [프로그래머스 더맵게](../master/python/프로그래머스_더맵게.py)
...
-   [프로그래머스 가장먼노드](../master/python/프로그래머스_가장먼노드.py)
...
-   [프로그래머스 입국심사](../master/python/프로그래머스_입국심사.py)
...
-   [프로그래머스 카펫](../master/python/프로그래머스_카펫.py)
...
-   [프로그래머스 쿼드압축후개수세기](../master/python/프로그래머스_쿼드압축후개수세기.py)
...
-   [BOJ 12738](../master/python/BOJ_12738.py)
...
-   [BOJ 17352](../master/python/BOJ_17352.py)
...
-   [BOJ 14003](../master/python/BOJ_14003.py)
...
-   [BOJ 7578](../master/python/BOJ_7578.py)
...
-   [BOJ 1759](../master/python/BOJ_1759.py)
...
-   [BOJ 1092](../master/python/BOJ_1092.py)
...
-   [BOJ 4949](../master/python/BOJ_4949.py)
...
-   [BOJ 11054](../master/python/BOJ_11054.py)
...
-   [BOJ 2243](../master/python/BOJ_2243.py)
...
-   [BOJ 11375](../master/python/BOJ_11375.py)
